...
declare global {
  ...
  interface HTMLAppUploadElement extends StencilComponents.AppUpload, HTMLStencilElement {}
  ...
  namespace JSX {
    interface IntrinsicElements {
      'app-upload': JSXElements.AppUploadAttributes;
    }
  }
  namespace JSXElements {
    export interface AppUploadAttributes extends HTMLAttributes {
